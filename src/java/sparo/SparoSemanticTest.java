...
public class SparoSemanticTest {

    static String[] TOKENS = { "ERROR", "TYPEID", "OBJECTID", "BOOL_CONST", "INT_CONST", "FLOAT_CONST", "STRING_CONST",
            "INT", "FLOAT", "STRING", "BOOL", "ARRAY", "TENSOR", "LPAREN", "RPAREN", "COLON", "AT", "SEMICOLON",
            "COMMA", "PLUS", "MINUS", "STAR", "SLASH", "PERCENT", "LT", "GT", "EQUALS", "LBRACE", "RBRACE", "LSQUARE",
            "RSQUARE", "DOT", "LTE", "GTE", "DOUBLE_EQUALS", "CLASS", "ELSE", "IF", "EXTENDS", "AFTER", "UNIQUE",
            "SHARED", "WEAK", "CONSTRUCT", "DESTRUCT", "THIS", "NULLPTR", "WHILE", "FOR", "BREAK", "NEW", "AND", "OR",
            "NOT", "NEW_UNIQUE", "NEW_SHARED", "VOID", "RETURN" };
    ...
    static void printAST(String filename) throws Exception {
        ...
        SparoLexer lexer = new SparoLexer(inStream);
        ...
        parser_error_flag = 0;
        SparoParser parser = new SparoParser(tokens);
        ...
        SparoParser.ProgramContext prog = null;
        try {
            prog = parser.program();
        } catch (Exception e) {
            // e.printStackTrace();
    ...
    public static class ParserError extends BaseErrorListener {
        ...
        @Override
        public void syntaxError(Recognizer<?, ?> recognizer, Object offendingSymbol, int line, int charPositionIntLine,
...
// static String[] TOKENS = {"ERROR", "TYPEID", "OBJECTID", "BOOL_CONST",
// "INT_CONST", "STR_CONST", "'('", "')'", "':'", "'@'", "';'", "','", "'+'",
// "'-'", "'*'", "'/'", "'~'", "'<'", "'='", "'{'", "'}'", "'.'", "DARROW",
// "LE", "ASSIGN", "CLASS", "ELSE", "FI", "IF", "IN", "INHERITS", "LET", "LOOP",
